...
from climbers_eye_backend.serializers import gym_serializers, user_serializers
from climbers_eye_backend.models import Gym, SprayWall, Boulder
from climbers_eye_backend.filters import GymFilter
...
class GymList(generics.ListCreateAPIView):
    ...
    serializer_class = gym_serializers.GymSerializer
...
class UserChooseGym(generics.UpdateAPIView):
    permission_classes = [permissions.IsAuthenticated]
    serializer_class = user_serializers.PersonSerializer
