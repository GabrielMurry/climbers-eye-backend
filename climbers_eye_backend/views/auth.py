...
from climbers_eye_backend.serializers import custom_token_serializer, user_serializers
from rest_framework import status, generics, permissions

class CustomTokenObtainPairView(TokenObtainPairView):
    serializer_class = custom_token_serializer.CustomTokenObtainPairSerializer
...
class UserSignup(generics.CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        serializer = user_serializers.PersonSerializer(data=request.data)
        serializer.is_valid(raise_exception=True)
