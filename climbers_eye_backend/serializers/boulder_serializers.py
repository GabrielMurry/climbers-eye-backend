...
from climbers_eye_backend.models import Boulder, SprayWall, Send, Person
from climbers_eye_backend.utils import constants
from climbers_eye_backend.serializers.fields import UrlField, GradeField
from climbers_eye_backend.serializers.mixins import BoulderMixin
...
class BoulderDetailSerializer(serializers.ModelSerializer, BoulderMixin):
    ...
    def get_boulderBarChartData(self, obj: Boulder):
        ...
        suggested_grade_count_dict = {constants.grade_labels[item['suggested_grade']]: item['count'] for item in queryset}
        data = []
        for grade in constants.grade_labels:
    ...
    def get_userSendsData(self, obj: Boulder):
        ...
        for sent_boulder in sent_boulders:
            DATA.append({
                ...
                'grade': constants.grade_labels[sent_boulder.suggested_grade],
