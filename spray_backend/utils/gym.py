...
def create_spraywall(spraywall_data, gym_instance):
    image_url = s3_image_url(spraywall_data['image_data'])
    spraywall_data['gym'] = gym_instance.id
    spraywall_data['spraywall_image_url'] = image_url
